...
//var k=tokenizer.getTokenSingleInLine(input1);
console.log(k);
...
console.log(k);
//var mapOne=tokenizer.getTokenFrequencyMap(input1);

//var mapTwo=tokenizer.getTokenFrequencyMap(input2);
//var threashold=0.8;
//var result=detector.detectClone(mapOne,mapTwo,threashold);
//console.log(mapOne);


//console.log(tokenizer.createToken(mapOne));
